# Autogenerated wrapper script for Faiss_CUDA_jll for x86_64-linux-gnu-cuda+11.8
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, MKL_jll, CUDA_Runtime_jll)
